...
public class MessageHandlerOSGiEventWrapper implements EventHandler {
	
	private final MessageHandler messageHandler;
	
	public MessageHandlerOSGiEventWrapper(MessageHandler messageHandler) {
		this.messageHandler = messageHandler;
	}
	
	@Override
	public void handleEvent(Event event) {
		Message message = (Message) event.getProperty("message");
