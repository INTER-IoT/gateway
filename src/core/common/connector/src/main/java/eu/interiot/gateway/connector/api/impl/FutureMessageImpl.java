...
public class FutureMessageImpl implements FutureMessage{
	
	private ResponseListener responseListener = null;
	private Message response = null;
	
	protected synchronized void setResponse(Message response) {
	...
	@Override
	public Message await(long timeOutMillis) {
		long stopTime = System.currentTimeMillis() + timeOutMillis;
		while(stopTime > System.currentTimeMillis() && isResponseNull());
		return this.response;
	}
	
	private synchronized boolean isResponseNull() {
