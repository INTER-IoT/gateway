 ...
 */
package eu.interiot.gateway.storage;
...
import eu.interiot.gateway.storage.api.VirtualStorageImpl;
...
public class Activator implements BundleActivator{
	...
	public void start(BundleContext context) throws Exception {
		...
		CacheService cacheService = context.getService(context.getServiceReference(CacheService.class));
		
		MessageDispatcher messageDispatcher = context.getService(context.getServiceReference(MessageDispatcher.class));
		MessageFilter filter = MessageFilter.Builder.all().build();
		
		VirtualStorageImpl virtualStorage = new VirtualStorageImpl(cacheService);
		messageDispatcher.subscribe(filter, virtualStorage);
		
		context.registerService(VirtualStorage.class, virtualStorage, null);
	}
